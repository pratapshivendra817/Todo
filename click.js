...
var task_container = document.querySelector('.tc');
...
var task_card_string = "<div class=\"sn\"></div><p class=\"tt\"><p class=\"ts color-red\">Not-Started</p><ion-icon class=\"delete fs-large mg-10\" name=\"close-circle-outline\"></ion-icon>"
var task_count = 5;
updateTaskCount();
eventSetter();
...
function eventSetter(){
    ...
    var progress_buttons = document.getElementsByClassName('sn');
